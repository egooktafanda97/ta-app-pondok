...
@section('script')
    ...
    <script>
        ...
        const URI = "/siswa_register/show-data";
            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        return `<a href="/siswa_register/show_detail/${row.id}" class="text-green-500">${data}</a>`
                    }
                },
                {
                    data: "alamat_lengkap",
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        ...
                        return `<div class="flex justify-between">
                                    <a href="/siswa_register/show_update/${row.id}" class="btn btn-success btn-sm mr-1 w-[50px] data-update" data-id="${row?.id}"><i class="fa fa-edit"></i></a> 
        ...
        $(document).on("click", ".data-destroy", function() {
            ...
            const url = "/siswa_register/destroy/" + id;
            destory(url);
        });
    </script>
@endsection
