...
@section('content')
    ...
    <!-- [ breadcrumb ] end -->
    <!-- [ Main Content ] start -->
    <form action="/daftarmandiri/store" enctype="multipart/form-data" method="post">
        @csrf
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                            ...
                            <div class="w-full pb-10 pt-2">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="asal_sekolah" name="asal_sekolah"
                                                type="text">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <div><small><i class="text-green-500">lampiran berupa scann (SKL/Ijazah) dan
                                                    syarat
                                                    lainnya</i></small></div>
                ...
                <div class="col-sm-12">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label for="ortu_jenis_kelamin">Jenis Kelamin:</label>
                                                ...
                                                <select class="form-select" aria-label="Default select example"
                                                id="ortu_jenis_kelamin" name="ortu_jenis_kelamin">
                                                <option value="Laki-Laki">Laki-laki</option>
                                                <option value="Perempuan">Perempuan</option>
                                            </select>
                                        </div>
                    ...
                    <div class="col-8 mt-5">
                        <div class="form-group w-full flex justify-end">
                            <button class="w-50 btn btn-primary bg-blue-500"
