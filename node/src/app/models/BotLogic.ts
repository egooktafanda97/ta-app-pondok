...
interface BotLogicCreationAttributes
  extends Optional<BotLogicAttributes, 'id'> {}

class BotLogic
  extends Model<BotLogicAttributes, BotLogicCreationAttributes>
  implements BotLogicAttributes
{
  public id!: number;
